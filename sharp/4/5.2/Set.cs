...
namespace _5._2
{
    class Set
    {
        ...
        public static Set operator +(Set a, Set b) // перегрузка оператора +
        {
            Set setsum = a.Union(b);
        ...
        public static Set operator %(Set a, Set b)
        {
            Set setsum = a.SymmetricDifference(b);
